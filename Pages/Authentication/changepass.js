    ...
    <SafeAreaView style={Style.safe}>
        <ScrollView>
            <View style={{height:"100%",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
                ...
                <View>
                    <Text style={{textAlign:"left",fontSize:18,marginTop:"4%"}}>New Password</Text>
                ...
                <View>
                    <Text style={{textAlign:"left",fontSize:18,marginTop:"4%"}}>Re-Enter Password</Text>
                    <TextInput placeholder='Re-Enter Password' style={{borderWidth:1,paddingLeft:10,fontSize:15,width:"90%",height:43,marginTop:"6%",backgroundColor:"#F3F3F3",borderRadius:7}}/>
                </View>
